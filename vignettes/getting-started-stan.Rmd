...
The [`submit_model()`](https://metrumresearchgroup.github.io/bbr.bayes/reference/stan_submit_model.html) call automatically saves this fit object to disk as well. You can pass either a path or model object to `read_fit_model()` and it will re-load the `CmdStanMCMC` object into memory.
