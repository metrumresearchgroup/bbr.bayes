...
$EST METHOD=BAYES CTYPE=0 SEED=2 NBURN=10 NITER=50 PRINT=10 MSFO1100-2.msf RANMETHOD=P PARAFPRINT=10000 BAYES_PHI_STORE=1

$TABLE NUM CL V2 Q V3 KA ETAS(1:LAST) EPRED IPRED NPDE EWRES NOPRINT ONEHEADER FILE=1100.tab RANMETHOD=P

$TABLE NUM EPRED IPRED NPDE EWRES
       NOPRINT ONEHEADER
